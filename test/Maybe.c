...
int main(int argc, char* argv[]) {
  ...
  // Id-to-Name map
  const u64 id_to_name_size = 8;
  char* id_to_name_data[id_to_name_size];
  id_to_name_data[7] = "PutStrLn_1";
  id_to_name_data[6] = "Main_0";
  id_to_name_data[2] = "Nothing_0";
  id_to_name_data[5] = "Main";
  id_to_name_data[3] = "Nothing";
  id_to_name_data[4] = "Just";
  id_to_name_data[0] = "Just_0";
  id_to_name_data[1] = "Just_1";
;
