...
#define _PRED__1_ (17)
#define _TWICE__1_ (34)
#define _POW2__0_ (38)
#define _IF__THEN__ELSE____SPLIT__B__4_ (7)
#define _MAIN_ (14)
#define _PLUS3__0_ (11)
#define _FAC__B__1_ (13)
#define _PRED__0_ (16)
#define _CONSUME__0_ (36)
#define _PUTSTRLN__1_ (10)
#define _FAC__0_ (21)
#define _POW2__1_ (29)
#define _PLUS3__1_ (12)
#define _PRED__SPLIT__A__1_ (19)
#define _IF__THEN__ELSE____0_ (30)
#define _FAC__SPLIT__A__1_ (23)
#define _IF__THEN__ELSE____2_ (32)
#define _CONSUME__B__1_ (1)
#define _FIB__SPLIT__A__1_ (26)
#define _FIB__B__1_ (25)
#define _TEST2__0_ (28)
#define _CONSUME__SPLIT__A__1_ (0)
#define _TWICE__0_ (33)
#define _FAC__1_ (22)
#define _TEST1__0_ (35)
#define _IF__THEN__ELSE____4_ (4)
#define _FIB__0_ (24)
#define _CONSUME__1_ (2)
#define _IF__THEN__ELSE____3_ (18)
#define _POW2__B__1_ (31)
#define _IF__THEN__ELSE____1_ (27)
#define _IFTE__0_ (3)
#define _FIB__1_ (20)
#define _MAIN__0_ (15)
#define _POW2__SPLIT__A__1_ (37)
      ...
      switch (get_tag(term)) {
        ...
        case CAL: {
          ...
          //GENERATED_REWRITE_RULES_STEP_0_START//
          {
            ...
            case _CONSUME__B__1_: {
              if (get_ari(term) == 1) {
                init = 0;
                continue;
              }
            };
            case _FIB__SPLIT__A__1_: {
              if (get_ari(term) == 1) {
                stk_push(&stack, host);
                host = get_loc(term, 0);
                continue;
          ...
          //GENERATED_REWRITE_RULES_STEP_1_START//
          {
            ...
            case _TWICE__1_: {
              if (1) {
                inc_cost(mem);
                u64 ret_0;
                if (get_tag(U_32(2)) == U32 && get_tag(ask_arg(mem, term, 0)) == U32) {
                  ret_0 = U_32(get_val(U_32(2)) * get_val(ask_arg(mem, term, 0)));
                  inc_cost(mem);
                } else {
                  u64 op2_1 = alloc(mem, 2);
                  link(mem, op2_1 + 0, U_32(2));
                  link(mem, op2_1 + 1, ask_arg(mem, term, 0));
                  ret_0 = Op2(MUL, op2_1);
                }
                u64 done = ret_0;
                link(mem, host, done);
            ...
            case _POW2__0_: {
              if (1) {
                ...
                link(mem, lam_0 + 1, Cal(1, 29, cal_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
            ...
            case _IF__THEN__ELSE____SPLIT__B__4_: {
              ...
              if ((get_tag(ask_arg(mem, term, 1)) == CTR && get_ext(ask_arg(mem, term, 1)) == 8u)) {
                inc_cost(mem);
              ...
              if ((get_tag(ask_arg(mem, term, 1)) == CTR && get_ext(ask_arg(mem, term, 1)) == 9u)) {
                inc_cost(mem);
            ...
            case _PLUS3__0_: {
              if (1) {
                ...
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Var(lam_0));
                link(mem, lam_0 + 1, Cal(1, 12, cal_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
            ...
            case _CONSUME__0_: {
              if (1) {
                ...
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Var(lam_0));
                link(mem, lam_0 + 1, Cal(1, 2, cal_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
            ...
            case _PLUS3__1_: {
              if (1) {
                inc_cost(mem);
                u64 ret_0;
                if (get_tag(U_32(3)) == U32 && get_tag(ask_arg(mem, term, 0)) == U32) {
                  ret_0 = U_32(get_val(U_32(3)) + get_val(ask_arg(mem, term, 0)));
                  inc_cost(mem);
                } else {
                  u64 op2_1 = alloc(mem, 2);
                  link(mem, op2_1 + 0, U_32(3));
                  link(mem, op2_1 + 1, ask_arg(mem, term, 0));
                  ret_0 = Op2(ADD, op2_1);
                }
                u64 done = ret_0;
            ...
            case _IF__THEN__ELSE____0_: {
              if (1) {
                ...
                link(mem, lam_3 + 1, Cal(4, 4, cal_4));
            ...
            case _FAC__SPLIT__A__1_: {
              ...
              if (1) {
                ...
                link(mem, cal_8 + 0, Cal(1, 13, cal_5));
                u64 ret_6;
                if (get_tag(dp1_2) == U32 && get_tag(Cal(1, 22, cal_8)) == U32) {
                  ret_6 = U_32(get_val(dp1_2) * get_val(Cal(1, 22, cal_8)));
                  inc_cost(mem);
                } else {
                  u64 op2_7 = alloc(mem, 2);
                  link(mem, op2_7 + 0, dp1_2);
                  link(mem, op2_7 + 1, Cal(1, 22, cal_8));
                  ret_6 = Op2(MUL, op2_7);
                }
                u64 done = ret_6;
                link(mem, host, done);
            ...
            case _IF__THEN__ELSE____2_: {
              if (1) {
                ...
                link(mem, lam_1 + 1, Cal(4, 4, cal_2));
                link(mem, lam_0 + 1, Lam(lam_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 2);
            ...
            case _FIB__SPLIT__A__1_: {
              ...
              if (1) {
                ...
                link(mem, cal_11 + 0, Cal(1, 25, cal_5));
                u64 ret_6;
                if (get_tag(Cal(1, 20, cal_10)) == U32 && get_tag(Cal(1, 20, cal_11)) == U32) {
                  ret_6 = U_32(get_val(Cal(1, 20, cal_10)) + get_val(Cal(1, 20, cal_11)));
                  inc_cost(mem);
                } else {
                  u64 op2_7 = alloc(mem, 2);
                  link(mem, op2_7 + 0, Cal(1, 20, cal_10));
                  link(mem, op2_7 + 1, Cal(1, 20, cal_11));
                  ret_6 = Op2(ADD, op2_7);
                }
                u64 done = ret_6;
                link(mem, host, done);
            ...
            case _FIB__B__1_: {
              if (1) {
                inc_cost(mem);
                u64 ret_0;
                if (get_tag(ask_arg(mem, term, 0)) == U32 && get_tag(U_32(2)) == U32) {
                  ret_0 = U_32(get_val(ask_arg(mem, term, 0)) - get_val(U_32(2)));
                  inc_cost(mem);
                } else {
                  u64 op2_1 = alloc(mem, 2);
                  link(mem, op2_1 + 0, ask_arg(mem, term, 0));
                  link(mem, op2_1 + 1, U_32(2));
                  ret_0 = Op2(SUB, op2_1);
                }
                u64 done = ret_0;
                link(mem, host, done);
            ...
            case _TEST2__0_: {
              if (1) {
                inc_cost(mem);
                u64 cal_0 = alloc(mem, 1);
                link(mem, cal_0 + 0, U_32(24));
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Cal(1, 29, cal_0));
                u64 done = Cal(1, 2, cal_1);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
                continue;
            ...
            case _CONSUME__SPLIT__A__1_: {
              ...
              if (1) {
                ...
                link(mem, cal_0 + 0, ask_arg(mem, term, 0));
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Cal(1, 1, cal_0));
                u64 done = Cal(1, 2, cal_1);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
                init = 1;
            ...
            case _TWICE__0_: {
              if (1) {
                ...
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Var(lam_0));
                link(mem, lam_0 + 1, Cal(1, 34, cal_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
            ...
            case _TEST1__0_: {
              if (1) {
                ...
                link(mem, cal_2 + 0, U_32(40));
                u64 cal_3 = alloc(mem, 1);
                link(mem, cal_3 + 0, Cal(1, 12, cal_2));
                u64 ret_0;
                if (get_tag(U_32(1)) == U32 && get_tag(Cal(1, 17, cal_3)) == U32) {
                  ret_0 = U_32(get_val(U_32(1)) + get_val(Cal(1, 17, cal_3)));
                  inc_cost(mem);
                } else {
                  u64 op2_1 = alloc(mem, 2);
                  link(mem, op2_1 + 0, U_32(1));
                  link(mem, op2_1 + 1, Cal(1, 17, cal_3));
                  ret_0 = Op2(ADD, op2_1);
                }
                u64 cal_4 = alloc(mem, 1);
                link(mem, cal_4 + 0, ret_0);
                u64 done = Cal(1, 17, cal_4);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
                continue;
            ...
            case _IF__THEN__ELSE____3_: {
              if (1) {
                ...
                link(mem, lam_0 + 1, Cal(4, 4, cal_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 3);
                init = 1;
            ...
            case _IF__THEN__ELSE____1_: {
              if (1) {
                ...
                link(mem, lam_2 + 1, Cal(4, 4, cal_3));
                link(mem, lam_1 + 1, Lam(lam_2));
                link(mem, lam_0 + 1, Lam(lam_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
            ...
            case _IFTE__0_: {
              if (1) {
                ...
                link(mem, cal_2 + 1, Ctr(0, 6, ctr_1));
                link(mem, cal_2 + 2, U_32(1));
                link(mem, cal_2 + 3, U_32(0));
                u64 done = Cal(4, 4, cal_2);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
                continue;
            ...
            case _MAIN__0_: {
              if (1) {
                inc_cost(mem);
                u64 cal_0 = alloc(mem, 1);
                link(mem, cal_0 + 0, U_32(40));
                u64 done = Cal(1, 20, cal_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
                continue;
            ...
            case _POW2__SPLIT__A__1_: {
              ...
              if (1) {
                ...
                link(mem, cal_0 + 0, ask_arg(mem, term, 0));
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Cal(1, 31, cal_0));
                u64 cal_2 = alloc(mem, 1);
                link(mem, cal_2 + 0, Cal(1, 29, cal_1));
                u64 done = Cal(1, 34, cal_2);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
                init = 1;
                continue;
...
int main(int argc, char* argv[]) {
  ...
  // Id-to-Name map
  const u64 id_to_name_size = 39;
  char* id_to_name_data[id_to_name_size];
  id_to_name_data[29] = "Pow2_1";
  id_to_name_data[22] = "Fac_1";
  id_to_name_data[11] = "Plus3_0";
  id_to_name_data[7] = "If_then_else__split_b_4";
  id_to_name_data[21] = "Fac_0";
  id_to_name_data[38] = "Pow2_0";
  id_to_name_data[4] = "If_then_else__4";
  id_to_name_data[23] = "Fac_split_a_1";
  id_to_name_data[37] = "Pow2_split_a_1";
  id_to_name_data[1] = "Consume_b_1";
  id_to_name_data[31] = "Pow2_b_1";
  id_to_name_data[8] = "False";
  id_to_name_data[17] = "Pred_1";
  id_to_name_data[10] = "PutStrLn_1";
  id_to_name_data[34] = "Twice_1";
  id_to_name_data[5] = "Matteo";
  id_to_name_data[24] = "Fib_0";
  id_to_name_data[27] = "If_then_else__1";
  id_to_name_data[15] = "Main_0";
  id_to_name_data[0] = "Consume_split_a_1";
  id_to_name_data[3] = "Ifte_0";
  id_to_name_data[12] = "Plus3_1";
  id_to_name_data[19] = "Pred_split_a_1";
  id_to_name_data[13] = "Fac_b_1";
  id_to_name_data[2] = "Consume_1";
  id_to_name_data[25] = "Fib_b_1";
  id_to_name_data[6] = "True_0";
  id_to_name_data[14] = "Main";
  id_to_name_data[36] = "Consume_0";
  id_to_name_data[33] = "Twice_0";
  id_to_name_data[18] = "If_then_else__3";
  id_to_name_data[26] = "Fib_split_a_1";
  id_to_name_data[16] = "Pred_0";
  id_to_name_data[30] = "If_then_else__0";
  id_to_name_data[20] = "Fib_1";
  id_to_name_data[9] = "True";
  id_to_name_data[32] = "If_then_else__2";
  id_to_name_data[35] = "Test1_0";
  id_to_name_data[28] = "Test2_0";
;
