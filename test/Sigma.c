...
#define _MAIN_ (4)
#define _Z__X2C____2_ (3)
#define _Z__X2C____0_ (2)
#define _PUTSTRLN__1_ (8)
#define _FST__SPLIT__A__1_ (9)
#define _SND__SPLIT__A__1_ (7)
#define _FST__0_ (0)
#define _SND__1_ (6)
#define _FST__1_ (1)
#define _SND__0_ (11)
#define _Z__X2C____1_ (12)
          ...
          //GENERATED_REWRITE_RULES_STEP_1_START//
          {
            ...
            case _Z__X2C____0_: {
              if (1) {
                ...
                link(mem, lam_1 + 1, Cal(2, 3, cal_2));
            ...
            case _SND__0_: {
              if (1) {
                ...
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Var(lam_0));
                link(mem, lam_0 + 1, Cal(1, 6, cal_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
            ...
            case _Z__X2C____1_: {
              if (1) {
                ...
                link(mem, lam_0 + 1, Cal(2, 3, cal_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
                init = 1;
...
int main(int argc, char* argv[]) {
  ...
  id_to_name_data[6] = "Snd_1";
  id_to_name_data[12] = "Z_x2C__1";
  id_to_name_data[3] = "Z_x2C__2";
  id_to_name_data[1] = "Fst_1";
  id_to_name_data[11] = "Snd_0";
  id_to_name_data[0] = "Fst_0";
  id_to_name_data[2] = "Z_x2C__0";
  id_to_name_data[4] = "Main";
  id_to_name_data[7] = "Snd_split_a_1";
  id_to_name_data[8] = "PutStrLn_1";
  id_to_name_data[9] = "Fst_split_a_1";
  id_to_name_data[10] = "Z_x2C_";
  id_to_name_data[5] = "Main_0";
;
