...
#define _Z__OR____2_ (25)
#define _PUTSTRLN__1_ (36)
#define _CONS__2_ (9)
#define _Z__OR____C__2_ (15)
#define _Z__OR____SPLIT__A__3_ (11)
#define _MONUS__SPLIT__3_ (30)
#define _RANGE__SPLIT__A__1_ (29)
#define _RANGE__1_ (19)
#define _APPEND__SPLIT__B__3_ (3)
#define _FILTER__3_ (24)
#define _LT__2_ (8)
#define _TRUE__0_ (0)
#define _MAIN__1_ (17)
#define _FILTER__SPLIT__C__3_ (32)
#define _IF__THEN__ELSE____4_ (27)
#define _FALSE__0_ (14)
#define _MAIN__0_ (23)
#define _QSORT__SPLIT__A__1_ (22)
#define _MONUS__2_ (37)
#define _MAIN_ (21)
#define _IF__THEN__ELSE____SPLIT__B__4_ (28)
#define _AT__2_ (12)
#define _LT__SPLIT__1_ (4)
#define _NIL__0_ (6)
#define _AT__SPLIT__A__2_ (13)
#define _GT__2_ (34)
#define _QSORT__1_ (18)
#define _RANGE__B__1_ (16)
#define _APPEND__3_ (2)
#define _Z__OR____D__2_ (33)
#define _GT__SPLIT__1_ (35)
#define _Z__OR____SPLIT__B__3_ (31)
      ...
      switch (get_tag(term)) {
        ...
        case CAL: {
          ...
          //GENERATED_REWRITE_RULES_STEP_0_START//
          {
            ...
            case _Z__OR____C__2_: {
              if (get_ari(term) == 2) {
                init = 0;
                continue;
              }
            };
            case _Z__OR____SPLIT__A__3_: {
              if (get_ari(term) == 3) {
                stk_push(&stack, host);
                host = get_loc(term, 0);
                continue;
          ...
          //GENERATED_REWRITE_RULES_STEP_1_START//
          {
            case _Z__OR____2_: {
              if (1) {
                ...
                link(mem, cal_11 + 2, Cal(2, 33, cal_10));
                u64 done = Cal(3, 11, cal_11);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 2);
                init = 1;
                continue;
            ...
            case _RANGE__SPLIT__A__1_: {
              ...
              if ((get_tag(ask_arg(mem, term, 0)) == U32 && get_val(ask_arg(mem, term, 0)) == 0u)) {
                ...
                link(mem, cal_1 + 0, U_32(0));
                link(mem, cal_1 + 1, Cal(0, 6, cal_0));
                u64 done = Cal(2, 9, cal_1);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
                init = 1;
                continue;
              ...
              if (1) {
                ...
                link(mem, cal_6 + 0, Cal(1, 16, cal_5));
                u64 cal_7 = alloc(mem, 2);
                link(mem, cal_7 + 0, dp1_2);
                link(mem, cal_7 + 1, Cal(1, 19, cal_6));
                u64 done = Cal(2, 9, cal_7);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
                init = 1;
                continue;
            ...
            case _APPEND__SPLIT__B__3_: {
              ...
              if ((get_tag(ask_arg(mem, term, 1)) == CTR && get_ext(ask_arg(mem, term, 1)) == 7u)) {
                inc_cost(mem);
                u64 done = ask_arg(mem, term, 2);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 3);
              ...
              if ((get_tag(ask_arg(mem, term, 1)) == CTR && get_ext(ask_arg(mem, term, 1)) == 10u)) {
                inc_cost(mem);
                u64 ctr_0 = alloc(mem, 0);
                u64 cal_1 = alloc(mem, 3);
                link(mem, cal_1 + 0, Ctr(0, 20, ctr_0));
                ...
                link(mem, cal_2 + 1, Cal(3, 2, cal_1));
                u64 done = Cal(2, 9, cal_2);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 3);
            ...
            case _MAIN__1_: {
              if (1) {
                ...
                link(mem, cal_1 + 0, Cal(1, 19, cal_0));
                u64 ctr_2 = alloc(mem, 0);
                u64 cal_3 = alloc(mem, 2);
                link(mem, cal_3 + 0, Cal(1, 18, cal_1));
                link(mem, cal_3 + 1, Ctr(0, 20, ctr_2));
                u64 done = Cal(2, 12, cal_3);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
                init = 1;
                continue;
            ...
            case _FILTER__SPLIT__C__3_: {
              ...
              if ((get_tag(ask_arg(mem, term, 2)) == CTR && get_ext(ask_arg(mem, term, 2)) == 7u)) {
                inc_cost(mem);
                u64 ctr_0 = alloc(mem, 0);
              ...
              if ((get_tag(ask_arg(mem, term, 2)) == CTR && get_ext(ask_arg(mem, term, 2)) == 10u)) {
                inc_cost(mem);
            ...
            case _QSORT__SPLIT__A__1_: {
              ...
              if ((get_tag(ask_arg(mem, term, 0)) == CTR && get_ext(ask_arg(mem, term, 0)) == 7u)) {
                inc_cost(mem);
                u64 ctr_0 = alloc(mem, 0);
                u64 done = Ctr(0, 7, ctr_0);
                link(mem, host, done);
              ...
              if ((get_tag(ask_arg(mem, term, 0)) == CTR && get_ext(ask_arg(mem, term, 0)) == 10u)) {
                inc_cost(mem);
                ...
                u64 ctr_22 = alloc(mem, 0);
                u64 lam_23 = alloc(mem, 2);
                u64 cal_24 = alloc(mem, 2);
                link(mem, cal_24 + 0, Var(lam_23));
                link(mem, cal_24 + 1, dp0_11);
                link(mem, lam_23 + 1, Cal(2, 8, cal_24));
                u64 cal_25 = alloc(mem, 3);
                link(mem, cal_25 + 0, Ctr(0, 20, ctr_22));
                link(mem, cal_25 + 1, Lam(lam_23));
                link(mem, cal_25 + 2, dp0_1);
                u64 cal_26 = alloc(mem, 0);
                u64 cal_27 = alloc(mem, 2);
                link(mem, cal_27 + 0, dp1_12);
                link(mem, cal_27 + 1, Cal(0, 6, cal_26));
                u64 cal_28 = alloc(mem, 3);
                link(mem, cal_28 + 0, Ctr(0, 20, ctr_21));
                link(mem, cal_28 + 1, Cal(3, 24, cal_25));
                link(mem, cal_28 + 2, Cal(2, 9, cal_27));
                u64 ctr_29 = alloc(mem, 0);
                u64 lam_30 = alloc(mem, 2);
                u64 cpy_31 = Var(lam_30);
                u64 dp0_32;
                u64 dp1_33;
                if (get_tag(cpy_31) == U32) {
                  inc_cost(mem);
                  dp0_32 = cpy_31;
                  dp1_33 = cpy_31;
                } else {
                  ...
                  link(mem, dup_34 + 2, cpy_31);
                  dp0_32 = Dp0(col_35, dup_34);
                  dp1_33 = Dp1(col_35, dup_34);
                }
                u64 cal_36 = alloc(mem, 2);
                link(mem, cal_36 + 0, dp0_16);
                link(mem, cal_36 + 1, dp0_32);
                u64 ctr_37 = alloc(mem, 2);
                link(mem, ctr_37 + 0, dp1_17);
                link(mem, ctr_37 + 1, dp1_33);
                u64 cal_38 = alloc(mem, 2);
                link(mem, cal_38 + 0, Cal(2, 8, cal_36));
                link(mem, cal_38 + 1, Ctr(2, 26, ctr_37));
                link(mem, lam_30 + 1, Cal(2, 25, cal_38));
                u64 cal_39 = alloc(mem, 3);
                link(mem, cal_39 + 0, Ctr(0, 20, ctr_29));
                link(mem, cal_39 + 1, Lam(lam_30));
                link(mem, cal_39 + 2, dp1_2);
                u64 cal_40 = alloc(mem, 3);
                link(mem, cal_40 + 0, Ctr(0, 20, ctr_20));
                link(mem, cal_40 + 1, Cal(3, 2, cal_28));
                link(mem, cal_40 + 2, Cal(3, 24, cal_39));
                u64 done = Cal(3, 2, cal_40);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
            ...
            case _Z__OR____D__2_: {
              if (1) {
                ...
                link(mem, cal_11 + 0, dp1_7);
                link(mem, cal_11 + 1, dp1_2);
                link(mem, cal_11 + 2, Cal(2, 15, cal_10));
                u64 done = Cal(3, 31, cal_11);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 2);
                init = 1;
                continue;
...
int main(int argc, char* argv[]) {
  ...
  id_to_name_data[11] = "Z_or__split_a_3";
  id_to_name_data[22] = "Qsort_split_a_1";
  id_to_name_data[8] = "Lt_2";
  id_to_name_data[36] = "PutStrLn_1";
  id_to_name_data[23] = "Main_0";
  id_to_name_data[5] = "False";
  id_to_name_data[20] = "Matteo";
  id_to_name_data[6] = "Nil_0";
  id_to_name_data[28] = "If_then_else__split_b_4";
  id_to_name_data[3] = "Append_split_b_3";
  id_to_name_data[2] = "Append_3";
  id_to_name_data[1] = "True";
  id_to_name_data[27] = "If_then_else__4";
  id_to_name_data[17] = "Main_1";
  id_to_name_data[26] = "Eq_2";
  id_to_name_data[29] = "Range_split_a_1";
  id_to_name_data[0] = "True_0";
  id_to_name_data[15] = "Z_or__c_2";
  id_to_name_data[7] = "Nil";
  id_to_name_data[30] = "Monus_split_3";
  id_to_name_data[31] = "Z_or__split_b_3";
  id_to_name_data[25] = "Z_or__2";
  id_to_name_data[10] = "Cons";
  id_to_name_data[14] = "False_0";
  id_to_name_data[13] = "At_split_a_2";
  id_to_name_data[34] = "Gt_2";
  id_to_name_data[16] = "Range_b_1";
  id_to_name_data[18] = "Qsort_1";
  id_to_name_data[35] = "Gt_split_1";
  id_to_name_data[32] = "Filter_split_c_3";
  id_to_name_data[37] = "Monus_2";
  id_to_name_data[19] = "Range_1";
  id_to_name_data[9] = "Cons_2";
  id_to_name_data[33] = "Z_or__d_2";
  id_to_name_data[4] = "Lt_split_1";
  id_to_name_data[24] = "Filter_3";
  id_to_name_data[12] = "At_2";
  id_to_name_data[21] = "Main";
;
