...
#define _LT__SPLIT__1_ (1)
#define _GEN__1_ (11)
#define _NODE__2_ (10)
#define _MONUS__SPLIT__3_ (20)
#define _MONUS__2_ (19)
#define _SUN__1_ (14)
#define _GEN__SPLIT__A__1_ (7)
#define _EQ__SPLIT__1_ (6)
#define _EQ__2_ (5)
#define _IF__3_ (17)
#define _LT__2_ (0)
#define _SUN__SPLIT__A__1_ (12)
#define _GT__2_ (16)
#define _MAIN__0_ (18)
#define _GT__SPLIT__1_ (2)
#define _LEAF__1_ (8)
#define _MAIN_ (21)
#define _GEN__B__1_ (9)
          ...
          //GENERATED_REWRITE_RULES_STEP_1_START//
          {
            ...
            case _GEN__SPLIT__A__1_: {
              ...
              if (1) {
                ...
                link(mem, cal_6 + 0, dp0_1);
                u64 cal_7 = alloc(mem, 1);
                link(mem, cal_7 + 0, dp1_2);
                u64 cal_8 = alloc(mem, 2);
                link(mem, cal_8 + 0, Cal(1, 11, cal_6));
                link(mem, cal_8 + 1, Cal(1, 11, cal_7));
                u64 done = Cal(2, 10, cal_8);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
                init = 1;
                continue;
            ...
            case _SUN__SPLIT__A__1_: {
              ...
              if ((get_tag(ask_arg(mem, term, 0)) == CTR && get_ext(ask_arg(mem, term, 0)) == 13u)) {
                ...
                u64 ret_0;
                if (get_tag(Cal(1, 14, cal_2)) == U32 && get_tag(Cal(1, 14, cal_3)) == U32) {
                  ret_0 = U_32(get_val(Cal(1, 14, cal_2)) + get_val(Cal(1, 14, cal_3)));
                  inc_cost(mem);
                } else {
                  u64 op2_1 = alloc(mem, 2);
                  link(mem, op2_1 + 0, Cal(1, 14, cal_2));
                  link(mem, op2_1 + 1, Cal(1, 14, cal_3));
                  ret_0 = Op2(ADD, op2_1);
                }
                u64 done = ret_0;
                link(mem, host, done);
              ...
              if ((get_tag(ask_arg(mem, term, 0)) == CTR && get_ext(ask_arg(mem, term, 0)) == 15u)) {
                inc_cost(mem);
                u64 done = U_32(1);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
            ...
            case _MAIN__0_: {
              if (1) {
                ...
                link(mem, cal_1 + 0, Cal(1, 11, cal_0));
                u64 done = Cal(1, 14, cal_1);
                link(mem, host, done);
...
int main(int argc, char* argv[]) {
  ...
  // Id-to-Name map
  const u64 id_to_name_size = 22;
  char* id_to_name_data[id_to_name_size];
  id_to_name_data[19] = "Monus_2";
  id_to_name_data[5] = "Eq_2";
  id_to_name_data[6] = "Eq_split_1";
  id_to_name_data[10] = "Node_2";
  id_to_name_data[3] = "True";
  id_to_name_data[16] = "Gt_2";
  id_to_name_data[0] = "Lt_2";
  id_to_name_data[7] = "Gen_split_a_1";
  id_to_name_data[2] = "Gt_split_1";
  id_to_name_data[13] = "Node";
  id_to_name_data[12] = "Sun_split_a_1";
  id_to_name_data[9] = "Gen_b_1";
  id_to_name_data[14] = "Sun_1";
  id_to_name_data[1] = "Lt_split_1";
  id_to_name_data[18] = "Main_0";
  id_to_name_data[20] = "Monus_split_3";
  id_to_name_data[11] = "Gen_1";
  id_to_name_data[21] = "Main";
  id_to_name_data[17] = "If_3";
  id_to_name_data[15] = "Leaf";
  id_to_name_data[8] = "Leaf_1";
  id_to_name_data[4] = "False";
;
