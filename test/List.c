...
#define _Z__X2237____1_ (6)
#define _Z__X2237____2_ (1)
#define _Z__X2237____0_ (0)
#define _X5BX5D__0_ (7)
          ...
          //GENERATED_REWRITE_RULES_STEP_1_START//
          {
            case _Z__X2237____1_: {
              if (1) {
                ...
                link(mem, lam_0 + 1, Cal(2, 1, cal_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
            ...
            case _Z__X2237____0_: {
              if (1) {
                ...
                link(mem, lam_1 + 1, Cal(2, 1, cal_2));
...
int main(int argc, char* argv[]) {
  ...
  id_to_name_data[1] = "Z_x2237__2";
  id_to_name_data[5] = "Main_0";
  id_to_name_data[4] = "Main";
  id_to_name_data[8] = "X5Bx5D";
  id_to_name_data[7] = "X5Bx5D_0";
  id_to_name_data[2] = "PutStrLn_1";
  id_to_name_data[6] = "Z_x2237__1";
  id_to_name_data[0] = "Z_x2237__0";
  id_to_name_data[3] = "Z_x2237_";
;
