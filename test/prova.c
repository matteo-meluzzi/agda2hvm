...
#define _LEAF__1_ (8)
#define _SUN__1_ (2)
#define _GEN__SPLIT__A_ (1)
#define _SUN__SPLIT__A_ (3)
#define _MATCH_ (10)
#define _NODE__2_ (6)
#define _MAIN__0_ (7)
#define _IF_ (11)
          ...
          //GENERATED_REWRITE_RULES_STEP_1_START//
          {
            ...
            case _GEN__SPLIT__A_: {
              ...
              if (1) {
                ...
                link(mem, cal_8 + 0, Cal(1, 0, cal_6));
                link(mem, cal_8 + 1, Cal(1, 0, cal_7));
                u64 done = Cal(2, 6, cal_8);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
                init = 1;
                continue;
            ...
            case _SUN__SPLIT__A_: {
              ...
              if ((get_tag(ask_arg(mem, term, 0)) == CTR && get_ext(ask_arg(mem, term, 0)) == 4u)) {
                ...
                link(mem, cal_13 + 0, dp1_2);
                u64 ret_10;
                if (get_tag(Cal(1, 2, cal_12)) == U32 && get_tag(Cal(1, 2, cal_13)) == U32) {
                  ret_10 = U_32(get_val(Cal(1, 2, cal_12)) + get_val(Cal(1, 2, cal_13)));
                  inc_cost(mem);
                } else {
                  u64 op2_11 = alloc(mem, 2);
                  link(mem, op2_11 + 0, Cal(1, 2, cal_12));
                  link(mem, op2_11 + 1, Cal(1, 2, cal_13));
            ...
            case _MAIN__0_: {
              if (1) {
                inc_cost(mem);
                u64 cal_0 = alloc(mem, 1);
                link(mem, cal_0 + 0, U_32(22));
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Cal(1, 0, cal_0));
...
int main(int argc, char* argv[]) {
  ...
  // Id-to-Name map
  const u64 id_to_name_size = 13;
  char* id_to_name_data[id_to_name_size];
  id_to_name_data[10] = "Match";
  id_to_name_data[12] = "Main";
  id_to_name_data[1] = "Gen_split_a";
  id_to_name_data[4] = "Node";
  id_to_name_data[5] = "Leaf";
  id_to_name_data[7] = "Main_0";
  id_to_name_data[8] = "Leaf_1";
  id_to_name_data[0] = "Gen_1";
  id_to_name_data[6] = "Node_2";
  id_to_name_data[3] = "Sun_split_a";
  id_to_name_data[2] = "Sun_1";
  id_to_name_data[11] = "If";
  id_to_name_data[9] = "Gen_b";
;
