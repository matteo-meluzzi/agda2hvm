          ...
          //GENERATED_REWRITE_RULES_STEP_1_START//
          {
            ...
            case _MAIN__0_: {
              if (1) {
                ...
                link(mem, ctr_1 + 0, U_32(33));
                link(mem, ctr_1 + 1, Ctr(0, 4, ctr_0));
                u64 ctr_2 = alloc(mem, 2);
                link(mem, ctr_2 + 0, U_32(100));
                link(mem, ctr_2 + 1, Ctr(2, 3, ctr_1));
                u64 ctr_3 = alloc(mem, 2);
                link(mem, ctr_3 + 0, U_32(108));
                link(mem, ctr_3 + 1, Ctr(2, 3, ctr_2));
                u64 ctr_4 = alloc(mem, 2);
                link(mem, ctr_4 + 0, U_32(114));
                link(mem, ctr_4 + 1, Ctr(2, 3, ctr_3));
                u64 ctr_5 = alloc(mem, 2);
                link(mem, ctr_5 + 0, U_32(111));
                link(mem, ctr_5 + 1, Ctr(2, 3, ctr_4));
                u64 ctr_6 = alloc(mem, 2);
                link(mem, ctr_6 + 0, U_32(87));
                link(mem, ctr_6 + 1, Ctr(2, 3, ctr_5));
                u64 ctr_7 = alloc(mem, 2);
                link(mem, ctr_7 + 0, U_32(32));
                link(mem, ctr_7 + 1, Ctr(2, 3, ctr_6));
                u64 ctr_8 = alloc(mem, 2);
                link(mem, ctr_8 + 0, U_32(44));
                link(mem, ctr_8 + 1, Ctr(2, 3, ctr_7));
                u64 ctr_9 = alloc(mem, 2);
                link(mem, ctr_9 + 0, U_32(111));
                link(mem, ctr_9 + 1, Ctr(2, 3, ctr_8));
                u64 ctr_10 = alloc(mem, 2);
                link(mem, ctr_10 + 0, U_32(108));
                link(mem, ctr_10 + 1, Ctr(2, 3, ctr_9));
                u64 ctr_11 = alloc(mem, 2);
                link(mem, ctr_11 + 0, U_32(108));
                link(mem, ctr_11 + 1, Ctr(2, 3, ctr_10));
                u64 ctr_12 = alloc(mem, 2);
                link(mem, ctr_12 + 0, U_32(101));
                link(mem, ctr_12 + 1, Ctr(2, 3, ctr_11));
                u64 ctr_13 = alloc(mem, 2);
                link(mem, ctr_13 + 0, U_32(72));
                link(mem, ctr_13 + 1, Ctr(2, 3, ctr_12));
                u64 cal_14 = alloc(mem, 1);
                link(mem, cal_14 + 0, Ctr(2, 3, ctr_13));
                u64 done = Cal(1, 2, cal_14);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
                continue;
...
int main(int argc, char* argv[]) {
  ...
  id_to_name_data[1] = "Main_0";
  id_to_name_data[0] = "Main";
  id_to_name_data[4] = "StrNil";
  id_to_name_data[3] = "StrCons";
  id_to_name_data[2] = "PutStrLn_1";
;
