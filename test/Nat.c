...
#define _EQ__2_ (11)
#define _MONUS__2_ (10)
#define _MAIN_ (0)
#define _EQ__SPLIT__1_ (2)
#define _MONUS__SPLIT__3_ (5)
#define _SUC__0_ (7)
#define _PUTSTRLN__1_ (6)
#define _ZERO__0_ (12)
#define _SUC__1_ (8)
...
int main(int argc, char* argv[]) {
  ...
  // Id-to-Name map
  const u64 id_to_name_size = 14;
  char* id_to_name_data[id_to_name_size];
  id_to_name_data[4] = "False";
  id_to_name_data[7] = "Suc_0";
  id_to_name_data[0] = "Main";
  id_to_name_data[8] = "Suc_1";
  id_to_name_data[10] = "Monus_2";
  id_to_name_data[11] = "Eq_2";
  id_to_name_data[6] = "PutStrLn_1";
  id_to_name_data[12] = "Zero_0";
  id_to_name_data[13] = "Zero";
  id_to_name_data[9] = "Suc";
  id_to_name_data[1] = "Main_0";
  id_to_name_data[2] = "Eq_split_1";
  id_to_name_data[3] = "True";
  id_to_name_data[5] = "Monus_split_3";
;
