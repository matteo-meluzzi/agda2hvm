...
#define _TEST2__0_ (75)
#define _Z__X2B____2_ (29)
#define _TEST4__0_ (43)
#define _MAP__5_ (3)
#define _TAIL__0_ (71)
#define _SUC__0_ (15)
#define _TEST1__0_ (77)
#define _Z__X2B____1_ (53)
#define _MAP__0_ (12)
#define _NOT__SPLIT__A__1_ (25)
#define _CON__2_ (49)
#define _HEAD__3_ (11)
#define _FIE__1_ (52)
#define _ITE__SPLIT__B__4_ (38)
#define _ITE__3_ (48)
#define _ITE__2_ (18)
#define _ID__1_ (20)
#define _MAP__3_ (76)
...
#define _HEAD__1_ (10)
#define _TWICE__1_ (0)
#define _Z__X2B____SPLIT__A__2_ (26)
#define _NOT__1_ (24)
#define _HEAD__0_ (45)
#define _POW2__0_ (62)
#define _TAIL__3_ (17)
#define _PRED__1_ (64)
#define _TAIL__SPLIT__C__3_ (4)
#define _NOT__0_ (59)
#define _MAP__1_ (14)
#define _MAP__2_ (61)
#define _FUN__0_ (65)
...
#define _CON__1_ (69)
#define _HEAD__2_ (74)
#define _FALSE__0_ (31)
#define _CON__0_ (13)
#define _MAP__SPLIT__E__5_ (58)
#define _MAIN__0_ (40)
#define _TEST3__0_ (46)
#define _FIE__0_ (55)
#define _CONSUME__1_ (51)
#define _THREE__0_ (7)
#define _CON__3_ (6)
#define _TWO__0_ (9)
#define _NIL__0_ (22)
#define _POW2__SPLIT__A__1_ (34)
#define _TAIL__1_ (73)
#define _PRED__SPLIT__A__1_ (70)
#define _TWICE__0_ (68)
#define _SUC__1_ (8)
#define _TWICE__SPLIT__A__1_ (1)
#define _MAIN_ (39)
#define _LOOP__0_ (21)
#define _PUTSTRLN__1_ (42)
#define _CONSUME__0_ (60)
#define _Z__X2B____0_ (72)
#define _CONSUME__SPLIT__A__1_ (50)
          ...
          //GENERATED_REWRITE_RULES_STEP_1_START//
          {
            case _TEST2__0_: {
              if (1) {
                ...
                link(mem, cal_1 + 0, Cal(0, 7, cal_0));
                u64 cal_2 = alloc(mem, 1);
                link(mem, cal_2 + 0, Cal(1, 0, cal_1));
                u64 cal_3 = alloc(mem, 1);
                link(mem, cal_3 + 0, Cal(1, 0, cal_2));
                u64 cal_4 = alloc(mem, 1);
                link(mem, cal_4 + 0, Cal(1, 0, cal_3));
                u64 cal_5 = alloc(mem, 1);
                link(mem, cal_5 + 0, Cal(1, 35, cal_4));
                u64 done = Cal(1, 51, cal_5);
                link(mem, host, done);
            ...
            case _TAIL__0_: {
              if (1) {
                ...
                link(mem, lam_2 + 1, Cal(3, 17, cal_3));
            ...
            case _SUC__0_: {
              if (1) {
                ...
                link(mem, lam_0 + 1, Cal(1, 8, cal_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
            ...
            case _TEST1__0_: {
              if (1) {
                ...
                link(mem, cal_4 + 0, Ctr(0, 47, ctr_0));
                link(mem, cal_4 + 1, Cal(0, 31, cal_1));
                link(mem, cal_4 + 2, Cal(0, 21, cal_2));
                link(mem, cal_4 + 3, Cal(0, 33, cal_3));
                u64 done = Cal(4, 19, cal_4);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
                continue;
            ...
            case _Z__X2B____1_: {
              if (1) {
                ...
                link(mem, lam_0 + 1, Cal(2, 29, cal_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
            ...
            case _MAP__0_: {
              if (1) {
                ...
                link(mem, lam_4 + 1, Cal(5, 3, cal_5));
            ...
            case _CON__2_: {
              if (1) {
                ...
                link(mem, lam_0 + 1, Cal(3, 6, cal_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 2);
                init = 1;
            ...
            case _ITE__SPLIT__B__4_: {
              ...
              if ((get_tag(ask_arg(mem, term, 1)) == CTR && get_ext(ask_arg(mem, term, 1)) == 32u)) {
                inc_cost(mem);
            ...
            case _ITE__3_: {
              if (1) {
                ...
                link(mem, lam_0 + 1, Cal(4, 19, cal_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 3);
                init = 1;
            ...
            case _ITE__2_: {
              if (1) {
                ...
                link(mem, lam_1 + 1, Cal(4, 19, cal_2));
                link(mem, lam_0 + 1, Lam(lam_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 2);
            ...
            case _MAP__3_: {
              if (1) {
                ...
                link(mem, lam_1 + 1, Cal(5, 3, cal_2));
                link(mem, lam_0 + 1, Lam(lam_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 3);
            ...
            case _TAIL__2_: {
              if (1) {
                ...
                link(mem, cal_1 + 1, ask_arg(mem, term, 1));
                link(mem, cal_1 + 2, Var(lam_0));
                link(mem, lam_0 + 1, Cal(3, 17, cal_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 2);
                init = 1;
            ...
            case _FOE__0_: {
              if (1) {
                ...
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Var(lam_0));
                link(mem, lam_0 + 1, Cal(1, 57, cal_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
            ...
            case _ITE__1_: {
              if (1) {
                ...
                link(mem, lam_2 + 1, Cal(4, 19, cal_3));
                link(mem, lam_1 + 1, Lam(lam_2));
                link(mem, lam_0 + 1, Lam(lam_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
            ...
            case _MAP__4_: {
              if (1) {
                ...
                link(mem, lam_0 + 1, Cal(5, 3, cal_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 4);
                init = 1;
            ...
            case _PRED__0_: {
              if (1) {
                ...
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Var(lam_0));
                link(mem, lam_0 + 1, Cal(1, 64, cal_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
            ...
            case _Z__X2B____SPLIT__A__2_: {
              ...
              if ((get_tag(ask_arg(mem, term, 0)) == CTR && get_ext(ask_arg(mem, term, 0)) == 27u)) {
                inc_cost(mem);
              ...
              if ((get_tag(ask_arg(mem, term, 0)) == CTR && get_ext(ask_arg(mem, term, 0)) == 28u)) {
                inc_cost(mem);
                ...
                link(mem, cal_6 + 0, Cal(2, 29, cal_5));
                u64 done = Cal(1, 8, cal_6);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 2);
            ...
            case _POW2__0_: {
              if (1) {
                ...
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Var(lam_0));
                link(mem, lam_0 + 1, Cal(1, 35, cal_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
            ...
            case _NOT__0_: {
              if (1) {
                ...
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Var(lam_0));
                link(mem, lam_0 + 1, Cal(1, 24, cal_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
            ...
            case _MAP__1_: {
              if (1) {
                ...
                link(mem, lam_3 + 1, Cal(5, 3, cal_4));
                link(mem, lam_2 + 1, Lam(lam_3));
                link(mem, lam_1 + 1, Lam(lam_2));
                link(mem, lam_0 + 1, Lam(lam_1));
                u64 done = Lam(lam_0);
            ...
            case _MAP__2_: {
              if (1) {
                ...
                link(mem, lam_2 + 1, Cal(5, 3, cal_3));
                link(mem, lam_1 + 1, Lam(lam_2));
                link(mem, lam_0 + 1, Lam(lam_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
            ...
            case _FUN__0_: {
              if (1) {
                ...
                u64 cal_0 = alloc(mem, 0);
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Cal(0, 37, cal_0));
                u64 cal_2 = alloc(mem, 1);
                link(mem, cal_2 + 0, Cal(1, 8, cal_1));
                u64 cal_3 = alloc(mem, 1);
                link(mem, cal_3 + 0, Cal(1, 8, cal_2));
                u64 cal_4 = alloc(mem, 0);
                u64 cal_5 = alloc(mem, 1);
                link(mem, cal_5 + 0, Cal(0, 37, cal_4));
                u64 cal_6 = alloc(mem, 1);
                link(mem, cal_6 + 0, Cal(1, 8, cal_5));
                u64 cal_7 = alloc(mem, 1);
                link(mem, cal_7 + 0, Cal(1, 8, cal_6));
                u64 cal_8 = alloc(mem, 2);
                link(mem, cal_8 + 0, Cal(1, 52, cal_3));
                link(mem, cal_8 + 1, Cal(1, 57, cal_7));
                u64 done = Cal(2, 29, cal_8);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
                continue;
            ...
            case _CON__1_: {
              if (1) {
                ...
                link(mem, cal_2 + 1, Var(lam_0));
                link(mem, cal_2 + 2, Var(lam_1));
                link(mem, lam_1 + 1, Cal(3, 6, cal_2));
                link(mem, lam_0 + 1, Lam(lam_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
            ...
            case _CON__0_: {
              if (1) {
                ...
                link(mem, cal_3 + 1, Var(lam_1));
                link(mem, cal_3 + 2, Var(lam_2));
                link(mem, lam_2 + 1, Cal(3, 6, cal_3));
                link(mem, lam_1 + 1, Lam(lam_2));
                link(mem, lam_0 + 1, Lam(lam_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
            ...
            case _MAP__SPLIT__E__5_: {
              ...
              if ((get_tag(ask_arg(mem, term, 4)) == CTR && get_ext(ask_arg(mem, term, 4)) == 23u)) {
                inc_cost(mem);
                u64 ctr_0 = alloc(mem, 0);
                u64 done = Ctr(0, 23, ctr_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 5);
              ...
              if ((get_tag(ask_arg(mem, term, 4)) == CTR && get_ext(ask_arg(mem, term, 4)) == 5u)) {
                inc_cost(mem);
                ...
                link(mem, cal_24 + 0, Ctr(0, 47, ctr_21));
                link(mem, cal_24 + 1, Ctr(0, 47, ctr_22));
                link(mem, cal_24 + 2, Ctr(0, 47, ctr_23));
                ...
                link(mem, cal_25 + 2, Cal(5, 3, cal_24));
                u64 done = Cal(3, 6, cal_25);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 5);
            ...
            case _TEST3__0_: {
              if (1) {
                ...
                link(mem, cal_9 + 0, Cal(0, 37, cal_8));
                u64 cal_10 = alloc(mem, 1);
                link(mem, cal_10 + 0, Cal(1, 8, cal_9));
                u64 cal_11 = alloc(mem, 0);
                u64 cal_12 = alloc(mem, 0);
                u64 cal_13 = alloc(mem, 1);
                link(mem, cal_13 + 0, Cal(0, 37, cal_12));
                u64 cal_14 = alloc(mem, 0);
                u64 cal_15 = alloc(mem, 1);
                link(mem, cal_15 + 0, Cal(0, 37, cal_14));
                u64 cal_16 = alloc(mem, 0);
                u64 cal_17 = alloc(mem, 0);
                u64 cal_18 = alloc(mem, 1);
                link(mem, cal_18 + 0, Cal(0, 37, cal_17));
                u64 cal_19 = alloc(mem, 1);
                link(mem, cal_19 + 0, Cal(1, 8, cal_18));
                u64 cal_20 = alloc(mem, 0);
                u64 cal_21 = alloc(mem, 3);
                link(mem, cal_21 + 0, Cal(0, 37, cal_16));
                link(mem, cal_21 + 1, Cal(1, 8, cal_19));
                link(mem, cal_21 + 2, Cal(0, 22, cal_20));
                u64 cal_22 = alloc(mem, 3);
                link(mem, cal_22 + 0, Cal(1, 8, cal_13));
                link(mem, cal_22 + 1, Cal(1, 8, cal_15));
                link(mem, cal_22 + 2, Cal(3, 6, cal_21));
                u64 cal_23 = alloc(mem, 3);
                link(mem, cal_23 + 0, Cal(1, 8, cal_10));
                link(mem, cal_23 + 1, Cal(0, 37, cal_11));
                link(mem, cal_23 + 2, Cal(3, 6, cal_22));
                u64 cal_24 = alloc(mem, 5);
                link(mem, cal_24 + 0, Ctr(0, 47, ctr_4));
                link(mem, cal_24 + 1, Ctr(0, 47, ctr_5));
                link(mem, cal_24 + 2, Ctr(0, 47, ctr_6));
                link(mem, cal_24 + 3, Cal(0, 15, cal_7));
                link(mem, cal_24 + 4, Cal(3, 6, cal_23));
                u64 cal_25 = alloc(mem, 3);
                link(mem, cal_25 + 0, Ctr(0, 47, ctr_2));
                link(mem, cal_25 + 1, Ctr(0, 47, ctr_3));
                link(mem, cal_25 + 2, Cal(5, 3, cal_24));
                u64 cal_26 = alloc(mem, 3);
                link(mem, cal_26 + 0, Ctr(0, 47, ctr_0));
                link(mem, cal_26 + 1, Ctr(0, 47, ctr_1));
                link(mem, cal_26 + 2, Cal(3, 17, cal_25));
                u64 done = Cal(3, 11, cal_26);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
                continue;
            ...
            case _FIE__0_: {
              if (1) {
                ...
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Var(lam_0));
                link(mem, lam_0 + 1, Cal(1, 52, cal_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
            ...
            case _THREE__0_: {
              if (1) {
                ...
                u64 cal_0 = alloc(mem, 0);
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Cal(0, 9, cal_0));
                u64 done = Cal(1, 8, cal_1);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
            ...
            case _TWO__0_: {
              if (1) {
                ...
                u64 cal_0 = alloc(mem, 0);
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Cal(0, 36, cal_0));
                u64 done = Cal(1, 8, cal_1);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
            ...
            case _POW2__SPLIT__A__1_: {
              ...
              if ((get_tag(ask_arg(mem, term, 0)) == CTR && get_ext(ask_arg(mem, term, 0)) == 27u)) {
                ...
                u64 ctr_0 = alloc(mem, 0);
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Ctr(0, 27, ctr_0));
                u64 done = Cal(1, 8, cal_1);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
                clear(mem, get_loc(ask_arg(mem, term, 0), 0), 0);
              ...
              if ((get_tag(ask_arg(mem, term, 0)) == CTR && get_ext(ask_arg(mem, term, 0)) == 28u)) {
                ...
                link(mem, cal_5 + 0, dp1_2);
                u64 cal_6 = alloc(mem, 1);
                link(mem, cal_6 + 0, Cal(1, 35, cal_5));
                u64 done = Cal(1, 0, cal_6);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
                clear(mem, get_loc(ask_arg(mem, term, 0), 0), 1);
                init = 1;
            ...
            case _TAIL__1_: {
              if (1) {
                ...
                link(mem, cal_2 + 1, Var(lam_0));
                link(mem, cal_2 + 2, Var(lam_1));
                link(mem, lam_1 + 1, Cal(3, 17, cal_2));
                link(mem, lam_0 + 1, Lam(lam_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
            ...
            case _TWICE__0_: {
              if (1) {
                ...
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Var(lam_0));
                link(mem, lam_0 + 1, Cal(1, 0, cal_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
            ...
            case _TWICE__SPLIT__A__1_: {
              ...
              if ((get_tag(ask_arg(mem, term, 0)) == CTR && get_ext(ask_arg(mem, term, 0)) == 28u)) {
                ...
                link(mem, cal_5 + 0, dp1_2);
                u64 cal_6 = alloc(mem, 1);
                link(mem, cal_6 + 0, Cal(1, 0, cal_5));
                u64 cal_7 = alloc(mem, 1);
                link(mem, cal_7 + 0, Cal(1, 8, cal_6));
                u64 done = Cal(1, 8, cal_7);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
                clear(mem, get_loc(ask_arg(mem, term, 0), 0), 1);
                init = 1;
            ...
            case _CONSUME__0_: {
              if (1) {
                ...
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Var(lam_0));
                link(mem, lam_0 + 1, Cal(1, 51, cal_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
            ...
            case _Z__X2B____0_: {
              if (1) {
                ...
                link(mem, lam_1 + 1, Cal(2, 29, cal_2));
                link(mem, lam_0 + 1, Lam(lam_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
            ...
            case _FOE__1_: {
              if (1) {
                ...
                link(mem, cal_0 + 0, ask_arg(mem, term, 0));
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Cal(1, 52, cal_0));
                u64 done = Cal(1, 8, cal_1);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
                init = 1;
...
int main(int argc, char* argv[]) {
  ...
  // Id-to-Name map
  const u64 id_to_name_size = 78;
  char* id_to_name_data[id_to_name_size];
  id_to_name_data[1] = "Twice_split_a_1";
  id_to_name_data[25] = "Not_split_a_1";
  id_to_name_data[43] = "Test4_0";
  id_to_name_data[12] = "Map_0";
  id_to_name_data[51] = "Consume_1";
  id_to_name_data[5] = "Con";
  id_to_name_data[8] = "Suc_1";
  id_to_name_data[31] = "False_0";
  id_to_name_data[22] = "Nil_0";
  id_to_name_data[47] = "Matteo";
  id_to_name_data[34] = "Pow2_split_a_1";
  id_to_name_data[6] = "Con_3";
  id_to_name_data[38] = "Ite_split_b_4";
  id_to_name_data[63] = "Pred_0";
  id_to_name_data[27] = "Zero";
  id_to_name_data[42] = "PutStrLn_1";
  id_to_name_data[14] = "Map_1";
  id_to_name_data[0] = "Twice_1";
  id_to_name_data[56] = "Id_0";
  id_to_name_data[66] = "Foe_0";
  id_to_name_data[40] = "Main_0";
  id_to_name_data[32] = "False";
  id_to_name_data[73] = "Tail_1";
  id_to_name_data[52] = "Fie_1";
  id_to_name_data[19] = "Ite_4";
  id_to_name_data[61] = "Map_2";
  id_to_name_data[58] = "Map_split_e_5";
  id_to_name_data[26] = "Z_x2B__split_a_2";
  id_to_name_data[57] = "Foe_1";
  id_to_name_data[37] = "Zero_0";
  id_to_name_data[45] = "Head_0";
  id_to_name_data[36] = "One_0";
  id_to_name_data[69] = "Con_1";
  id_to_name_data[54] = "Head_split_c_3";
  id_to_name_data[64] = "Pred_1";
  id_to_name_data[23] = "Nil";
  id_to_name_data[72] = "Z_x2B__0";
  id_to_name_data[74] = "Head_2";
  id_to_name_data[10] = "Head_1";
  id_to_name_data[16] = "Tail_2";
  id_to_name_data[11] = "Head_3";
  id_to_name_data[50] = "Consume_split_a_1";
  id_to_name_data[53] = "Z_x2B__1";
  id_to_name_data[24] = "Not_1";
  id_to_name_data[59] = "Not_0";
  id_to_name_data[44] = "Z123x27x23x7CHx5Cx65llo_0";
  id_to_name_data[65] = "Fun_0";
  id_to_name_data[75] = "Test2_0";
  id_to_name_data[28] = "Suc";
  id_to_name_data[77] = "Test1_0";
  id_to_name_data[46] = "Test3_0";
  id_to_name_data[9] = "Two_0";
  id_to_name_data[3] = "Map_5";
  id_to_name_data[4] = "Tail_split_c_3";
  id_to_name_data[20] = "Id_1";
  id_to_name_data[30] = "True";
  id_to_name_data[48] = "Ite_3";
  id_to_name_data[2] = "Map_4";
  id_to_name_data[49] = "Con_2";
  id_to_name_data[55] = "Fie_0";
  id_to_name_data[60] = "Consume_0";
  id_to_name_data[67] = "Ite_0";
  id_to_name_data[70] = "Pred_split_a_1";
  id_to_name_data[17] = "Tail_3";
  id_to_name_data[41] = "Ite_1";
  id_to_name_data[7] = "Three_0";
  id_to_name_data[21] = "Loop_0";
  id_to_name_data[13] = "Con_0";
  id_to_name_data[35] = "Pow2_1";
  id_to_name_data[62] = "Pow2_0";
  id_to_name_data[29] = "Z_x2B__2";
  id_to_name_data[18] = "Ite_2";
  id_to_name_data[33] = "True_0";
  id_to_name_data[68] = "Twice_0";
  id_to_name_data[71] = "Tail_0";
  id_to_name_data[39] = "Main";
  id_to_name_data[15] = "Suc_0";
  id_to_name_data[76] = "Map_3";
;
