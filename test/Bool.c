...
#define _MONUS__SPLIT__3_ (4)
#define _EQ__SPLIT__1_ (1)
#define _MAIN_ (9)
#define _TRUE__0_ (7)
#define _EQ__2_ (6)
...
int main(int argc, char* argv[]) {
  ...
  id_to_name_data[5] = "Monus_2";
  id_to_name_data[1] = "Eq_split_1";
  id_to_name_data[4] = "Monus_split_3";
  id_to_name_data[8] = "False_0";
  id_to_name_data[7] = "True_0";
  id_to_name_data[3] = "False";
  id_to_name_data[6] = "Eq_2";
  id_to_name_data[9] = "Main";
  id_to_name_data[10] = "Main_0";
