...
#define _X2264X2DTRANS__SPLIT__D__5_ (35)
#define _TRINAT__C__2_ (48)
#define _MONUS__SPLIT__3_ (62)
#define _TRINAT__0_ (14)
#define _TRINAT__SPLIT__B__3_ (49)
#define _X2264X2DTRANS__5_ (52)
#define _MONUS__2_ (61)
#define _MAIN__0_ (39)
#define _EQ__SPLIT__1_ (11)
#define _X5BX5D__0_ (29)
#define _LT__SPLIT__1_ (59)
#define _X2264X2DREFL__1_ (44)
#define _GT__SPLIT__1_ (72)
#define _TRINAT__E__4_ (40)
#define _X2264X2DDEC__D__3_ (33)
#define _TEST1__0_ (26)
#define _TRINAT__SPLIT__E__5_ (18)
#define _FROMLIST__3_ (7)
#define _INSERT__SPLIT__M__12_ (56)
#define _X2264X2DDEC__SPLIT__A__3_ (32)
#define _X2264X2DZERO__1_ (9)
#define _FROMLIST__SPLIT__C__3_ (0)
#define _LESS__3_ (20)
#define _X2264X2DTRANS__3_ (45)
#define _INSERT__8_ (6)
#define _NODE__3_ (30)
#define _ORD_CONSTRUCTOR__4_ (43)
#define _SORT__3_ (16)
#define _TRINAT__SPLIT__A__2_ (46)
#define _TDOX2DNAT__0_ (27)
#define _TRINAT__SPLIT__B__2_ (47)
#define _INSERT__M__11_ (65)
#define _X2DX221EX2DX2264__1_ (3)
#define _FLATTEN__5_ (17)
#define _INSERT__SPLIT__F__8_ (67)
#define _X2264X2DSUC__3_ (21)
#define _GT__2_ (75)
#define _Z__X2BX2B____SPLIT__B__3_ (51)
#define _TRINAT__D__3_ (60)
#define _EQ__2_ (70)
#define _X2264X2DTRANS__SPLIT__E__8_ (37)
#define _LEAF__1_ (2)
#define _X2264X2DREFL__B__1_ (74)
#define _Z__X2237____2_ (28)
#define _IF__3_ (64)
#define _X2BX221EX2DX2264__1_ (8)
#define _GREATER__3_ (25)
#define _LT__2_ (58)
#define _ORDX2DNAT__0_ (42)
#define _TDO_CONSTRUCTOR__2_ (68)
#define _X2264X2DREFL__SPLIT__A__1_ (71)
#define _MAIN_ (38)
#define _X2264X2DDEC__3_ (34)
#define _FLATTEN__SPLIT__E__5_ (41)
#define _TRINAT__2_ (15)
#define _X5BX5DX2DX2264__3_ (54)
#define _EQUAL__3_ (23)
#define _Z__X2BX2B____3_ (50)
        ...
        case CAL: {
          ...
          //GENERATED_REWRITE_RULES_STEP_1_START//
          {
            case _X2264X2DTRANS__SPLIT__D__5_: {
              ...
              if ((get_tag(ask_arg(mem, term, 3)) == CTR && get_ext(ask_arg(mem, term, 3)) == 10u)) {
                inc_cost(mem);
                u64 ctr_0 = alloc(mem, 0);
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Ctr(0, 4, ctr_0));
                u64 done = Cal(1, 9, cal_1);
                link(mem, host, done);
              ...
              if ((get_tag(ask_arg(mem, term, 3)) == CTR && get_ext(ask_arg(mem, term, 3)) == 36u)) {
                inc_cost(mem);
            ...
            case _TRINAT__SPLIT__B__3_: {
              ...
              if ((get_tag(ask_arg(mem, term, 1)) == U32 && get_val(ask_arg(mem, term, 1)) == 0u)) {
                ...
                link(mem, cal_4 + 1, Ctr(0, 4, ctr_2));
                link(mem, cal_4 + 2, Ctr(0, 4, ctr_3));
                u64 cal_5 = alloc(mem, 3);
                link(mem, cal_5 + 0, Ctr(0, 4, ctr_0));
                link(mem, cal_5 + 1, Ctr(0, 4, ctr_1));
                link(mem, cal_5 + 2, Cal(3, 34, cal_4));
                u64 done = Cal(3, 25, cal_5);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 3);
                collect(mem, ask_arg(mem, term, 0));
                collect(mem, ask_arg(mem, term, 2));
              ...
              if (1) {
                ...
                link(mem, cal_37 + 4, Cal(4, 40, cal_36));
                u64 done = Cal(5, 18, cal_37);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 3);
                init = 1;
                continue;
            ...
            case _TEST1__0_: {
              if (1) {
                ...
                link(mem, cal_3 + 0, U_32(6));
                link(mem, cal_3 + 1, Cal(0, 29, cal_2));
                u64 cal_4 = alloc(mem, 2);
                link(mem, cal_4 + 0, U_32(8));
                link(mem, cal_4 + 1, Cal(2, 28, cal_3));
                u64 cal_5 = alloc(mem, 2);
                link(mem, cal_5 + 0, U_32(4));
                link(mem, cal_5 + 1, Cal(2, 28, cal_4));
                u64 cal_6 = alloc(mem, 2);
                link(mem, cal_6 + 0, U_32(7));
                link(mem, cal_6 + 1, Cal(2, 28, cal_5));
                u64 cal_7 = alloc(mem, 2);
                link(mem, cal_7 + 0, U_32(10));
                link(mem, cal_7 + 1, Cal(2, 28, cal_6));
                u64 cal_8 = alloc(mem, 2);
                link(mem, cal_8 + 0, U_32(2));
                link(mem, cal_8 + 1, Cal(2, 28, cal_7));
                u64 cal_9 = alloc(mem, 2);
                link(mem, cal_9 + 0, U_32(1));
                link(mem, cal_9 + 1, Cal(2, 28, cal_8));
                u64 cal_10 = alloc(mem, 2);
                link(mem, cal_10 + 0, U_32(9));
                link(mem, cal_10 + 1, Cal(2, 28, cal_9));
                u64 cal_11 = alloc(mem, 2);
                link(mem, cal_11 + 0, U_32(3));
                link(mem, cal_11 + 1, Cal(2, 28, cal_10));
                u64 cal_12 = alloc(mem, 2);
                link(mem, cal_12 + 0, U_32(5));
                link(mem, cal_12 + 1, Cal(2, 28, cal_11));
                u64 cal_13 = alloc(mem, 3);
                link(mem, cal_13 + 0, Ctr(0, 4, ctr_0));
                link(mem, cal_13 + 1, Cal(0, 27, cal_1));
                link(mem, cal_13 + 2, Cal(2, 28, cal_12));
                u64 done = Cal(3, 16, cal_13);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
                continue;
            ...
            case _TRINAT__SPLIT__E__5_: {
              ...
              if ((get_tag(ask_arg(mem, term, 4)) == CTR && get_ext(ask_arg(mem, term, 4)) == 19u)) {
                inc_cost(mem);
                u64 ctr_0 = alloc(mem, 0);
                u64 ctr_1 = alloc(mem, 0);
                u64 ctr_2 = alloc(mem, 0);
                u64 ctr_3 = alloc(mem, 0);
                u64 cal_4 = alloc(mem, 3);
                link(mem, cal_4 + 0, Ctr(0, 4, ctr_2));
                link(mem, cal_4 + 1, Ctr(0, 4, ctr_3));
                link(mem, cal_4 + 2, ask_arg(mem, ask_arg(mem, term, 4), 2));
                u64 cal_5 = alloc(mem, 3);
                link(mem, cal_5 + 0, Ctr(0, 4, ctr_0));
                link(mem, cal_5 + 1, Ctr(0, 4, ctr_1));
                link(mem, cal_5 + 2, Cal(3, 21, cal_4));
                u64 done = Cal(3, 20, cal_5);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 5);
              ...
              if ((get_tag(ask_arg(mem, term, 4)) == CTR && get_ext(ask_arg(mem, term, 4)) == 22u)) {
                inc_cost(mem);
                u64 ctr_0 = alloc(mem, 0);
                u64 ctr_1 = alloc(mem, 0);
                u64 ctr_2 = alloc(mem, 0);
                u64 cal_3 = alloc(mem, 3);
                link(mem, cal_3 + 0, Ctr(0, 4, ctr_0));
                link(mem, cal_3 + 1, Ctr(0, 4, ctr_1));
                link(mem, cal_3 + 2, Ctr(0, 4, ctr_2));
                u64 done = Cal(3, 23, cal_3);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 5);
                clear(mem, get_loc(ask_arg(mem, term, 4), 0), 3);
                collect(mem, ask_arg(mem, term, 0));
            ...
            case _INSERT__SPLIT__M__12_: {
              ...
              if ((get_tag(ask_arg(mem, term, 11)) == CTR && get_ext(ask_arg(mem, term, 11)) == 19u)) {
                inc_cost(mem);
                u64 ctr_0 = alloc(mem, 0);
                u64 ctr_1 = alloc(mem, 0);
                u64 ctr_2 = alloc(mem, 0);
              ...
              if ((get_tag(ask_arg(mem, term, 11)) == CTR && get_ext(ask_arg(mem, term, 11)) == 22u)) {
                inc_cost(mem);
              ...
              if ((get_tag(ask_arg(mem, term, 11)) == CTR && get_ext(ask_arg(mem, term, 11)) == 24u)) {
                inc_cost(mem);
                u64 ctr_0 = alloc(mem, 0);
                u64 ctr_1 = alloc(mem, 0);
                u64 ctr_2 = alloc(mem, 0);
            ...
            case _X2264X2DDEC__SPLIT__A__3_: {
              ...
              if (1) {
                ...
                u64 ctr_4 = alloc(mem, 0);
                u64 cal_5 = alloc(mem, 3);
                link(mem, cal_5 + 0, Cal(3, 33, cal_0));
                link(mem, cal_5 + 1, Ctr(0, 4, ctr_3));
                link(mem, cal_5 + 2, Ctr(0, 4, ctr_4));
                u64 cal_6 = alloc(mem, 3);
                link(mem, cal_6 + 0, Ctr(0, 4, ctr_1));
                link(mem, cal_6 + 1, Ctr(0, 4, ctr_2));
                link(mem, cal_6 + 2, Cal(3, 34, cal_5));
                u64 done = Cal(3, 21, cal_6);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 3);
                init = 1;
                continue;
            ...
            case _FROMLIST__SPLIT__C__3_: {
              ...
              if ((get_tag(ask_arg(mem, term, 2)) == CTR && get_ext(ask_arg(mem, term, 2)) == 1u)) {
                inc_cost(mem);
                u64 ctr_0 = alloc(mem, 0);
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Ctr(0, 4, ctr_0));
                u64 cal_2 = alloc(mem, 1);
                link(mem, cal_2 + 0, Cal(1, 3, cal_1));
                u64 done = Cal(1, 2, cal_2);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 3);
              ...
              if ((get_tag(ask_arg(mem, term, 2)) == CTR && get_ext(ask_arg(mem, term, 2)) == 5u)) {
                inc_cost(mem);
                u64 cpy_0 = ask_arg(mem, term, 1);
                u64 dp0_1;
                u64 dp1_2;
                ...
                link(mem, cal_9 + 0, Ctr(0, 4, ctr_8));
                link(mem, cal_9 + 1, dp1_2);
                link(mem, cal_9 + 2, ask_arg(mem, ask_arg(mem, term, 2), 1));
                u64 ctr_10 = alloc(mem, 0);
                u64 cal_11 = alloc(mem, 1);
                link(mem, cal_11 + 0, Ctr(0, 4, ctr_10));
                u64 ctr_12 = alloc(mem, 0);
                u64 cal_13 = alloc(mem, 1);
                link(mem, cal_13 + 0, Ctr(0, 4, ctr_12));
                u64 cal_14 = alloc(mem, 8);
                link(mem, cal_14 + 0, Ctr(0, 4, ctr_5));
                link(mem, cal_14 + 1, dp0_1);
                link(mem, cal_14 + 2, Ctr(0, 4, ctr_6));
                link(mem, cal_14 + 3, Ctr(0, 4, ctr_7));
                link(mem, cal_14 + 4, ask_arg(mem, ask_arg(mem, term, 2), 0));
                link(mem, cal_14 + 5, Cal(3, 7, cal_9));
                link(mem, cal_14 + 6, Cal(1, 3, cal_11));
                link(mem, cal_14 + 7, Cal(1, 8, cal_13));
                u64 done = Cal(8, 6, cal_14);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 3);
            ...
            case _X2264X2DTRANS__3_: {
              if (1) {
                ...
                link(mem, lam_1 + 1, Cal(5, 52, cal_2));
                link(mem, lam_0 + 1, Lam(lam_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 3);
            ...
            case _SORT__3_: {
              if (1) {
                ...
                u64 ctr_4 = alloc(mem, 0);
                u64 cal_5 = alloc(mem, 3);
                link(mem, cal_5 + 0, Ctr(0, 4, ctr_4));
                link(mem, cal_5 + 1, ask_arg(mem, term, 1));
                link(mem, cal_5 + 2, ask_arg(mem, term, 2));
                u64 cal_6 = alloc(mem, 5);
                link(mem, cal_6 + 0, Ctr(0, 4, ctr_0));
                link(mem, cal_6 + 1, Ctr(0, 4, ctr_1));
                link(mem, cal_6 + 2, Ctr(0, 4, ctr_2));
                link(mem, cal_6 + 3, Ctr(0, 4, ctr_3));
                link(mem, cal_6 + 4, Cal(3, 7, cal_5));
                u64 done = Cal(5, 17, cal_6);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 3);
                collect(mem, ask_arg(mem, term, 0));
                init = 1;
            ...
            case _TRINAT__SPLIT__A__2_: {
              ...
              if (1) {
                ...
                link(mem, cal_11 + 2, Cal(2, 48, cal_10));
                u64 done = Cal(3, 49, cal_11);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 2);
                init = 1;
                continue;
            ...
            case _TDOX2DNAT__0_: {
              if (1) {
                ...
                u64 cal_1 = alloc(mem, 0);
                u64 cal_2 = alloc(mem, 2);
                link(mem, cal_2 + 0, Cal(0, 42, cal_0));
                link(mem, cal_2 + 1, Cal(0, 14, cal_1));
                u64 done = Cal(2, 68, cal_2);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
                continue;
            ...
            case _INSERT__SPLIT__F__8_: {
              ...
              if ((get_tag(ask_arg(mem, term, 5)) == CTR && get_ext(ask_arg(mem, term, 5)) == 53u)) {
                inc_cost(mem);
                u64 cal_0 = alloc(mem, 1);
                ...
                link(mem, cal_2 + 1, Cal(1, 2, cal_0));
                link(mem, cal_2 + 2, Cal(1, 2, cal_1));
                u64 done = Cal(3, 30, cal_2);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 8);
              ...
              if ((get_tag(ask_arg(mem, term, 5)) == CTR && get_ext(ask_arg(mem, term, 5)) == 31u)) {
                inc_cost(mem);
                ...
                link(mem, cal_72 + 11, Cal(11, 65, cal_71));
                u64 done = Cal(12, 56, cal_72);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 8);
            ...
            case _Z__X2BX2B____SPLIT__B__3_: {
              ...
              if ((get_tag(ask_arg(mem, term, 1)) == CTR && get_ext(ask_arg(mem, term, 1)) == 1u)) {
                inc_cost(mem);
              ...
              if ((get_tag(ask_arg(mem, term, 1)) == CTR && get_ext(ask_arg(mem, term, 1)) == 5u)) {
                inc_cost(mem);
                u64 ctr_0 = alloc(mem, 0);
                ...
                link(mem, cal_2 + 1, Cal(3, 50, cal_1));
                u64 done = Cal(2, 28, cal_2);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 3);
            ...
            case _X2264X2DTRANS__SPLIT__E__8_: {
              ...
              if ((get_tag(ask_arg(mem, term, 4)) == CTR && get_ext(ask_arg(mem, term, 4)) == 36u)) {
                inc_cost(mem);
                u64 ctr_0 = alloc(mem, 0);
                u64 ctr_1 = alloc(mem, 0);
                u64 ctr_2 = alloc(mem, 0);
                ...
                link(mem, cal_5 + 0, Ctr(0, 4, ctr_2));
                link(mem, cal_5 + 1, Ctr(0, 4, ctr_3));
                link(mem, cal_5 + 2, Ctr(0, 4, ctr_4));
                ...
                link(mem, cal_6 + 0, Ctr(0, 4, ctr_0));
                link(mem, cal_6 + 1, Ctr(0, 4, ctr_1));
                link(mem, cal_6 + 2, Cal(5, 52, cal_5));
                u64 done = Cal(3, 21, cal_6);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 8);
                clear(mem, get_loc(ask_arg(mem, term, 4), 0), 3);
            ...
            case _IF__3_: {
              ...
              if ((get_tag(ask_arg(mem, term, 0)) == CTR && get_ext(ask_arg(mem, term, 0)) == 12u)) {
                inc_cost(mem);
            ...
            case _ORDX2DNAT__0_: {
              if (1) {
                ...
                link(mem, lam_1 + 1, Cal(1, 44, cal_2));
                ...
                u64 ctr_8 = alloc(mem, 0);
                u64 cal_9 = alloc(mem, 3);
                link(mem, cal_9 + 0, Ctr(0, 4, ctr_6));
                link(mem, cal_9 + 1, Ctr(0, 4, ctr_7));
                link(mem, cal_9 + 2, Ctr(0, 4, ctr_8));
                link(mem, lam_5 + 0, Era());
                link(mem, lam_5 + 1, Cal(3, 45, cal_9));
                ...
                link(mem, cal_11 + 0, Ctr(0, 4, ctr_0));
                link(mem, cal_11 + 1, Lam(lam_1));
                link(mem, cal_11 + 2, Lam(lam_3));
                link(mem, cal_11 + 3, Ctr(0, 4, ctr_10));
                u64 done = Cal(4, 43, cal_11);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
                continue;
            ...
            case _X2264X2DREFL__SPLIT__A__1_: {
              ...
              if (1) {
                ...
                link(mem, cal_3 + 0, Cal(1, 74, cal_0));
                u64 cal_4 = alloc(mem, 3);
                link(mem, cal_4 + 0, Ctr(0, 4, ctr_1));
                link(mem, cal_4 + 1, Ctr(0, 4, ctr_2));
                link(mem, cal_4 + 2, Cal(1, 44, cal_3));
                u64 done = Cal(3, 21, cal_4);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
                init = 1;
                continue;
            ...
            case _FLATTEN__SPLIT__E__5_: {
              ...
              if ((get_tag(ask_arg(mem, term, 4)) == CTR && get_ext(ask_arg(mem, term, 4)) == 53u)) {
                inc_cost(mem);
                u64 cal_0 = alloc(mem, 0);
                u64 done = Cal(0, 29, cal_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 5);
              ...
              if ((get_tag(ask_arg(mem, term, 4)) == CTR && get_ext(ask_arg(mem, term, 4)) == 31u)) {
                inc_cost(mem);
                u64 ctr_0 = alloc(mem, 0);
                u64 ctr_1 = alloc(mem, 0);
                u64 ctr_2 = alloc(mem, 0);
                ...
                u64 ctr_4 = alloc(mem, 0);
                u64 cal_5 = alloc(mem, 5);
                link(mem, cal_5 + 0, Ctr(0, 4, ctr_1));
                link(mem, cal_5 + 1, Ctr(0, 4, ctr_2));
                link(mem, cal_5 + 2, Ctr(0, 4, ctr_3));
                link(mem, cal_5 + 3, Ctr(0, 4, ctr_4));
                ...
                link(mem, cal_10 + 0, Ctr(0, 4, ctr_6));
                link(mem, cal_10 + 1, Ctr(0, 4, ctr_7));
                link(mem, cal_10 + 2, Ctr(0, 4, ctr_8));
                link(mem, cal_10 + 3, Ctr(0, 4, ctr_9));
                link(mem, cal_10 + 4, ask_arg(mem, ask_arg(mem, term, 4), 2));
                u64 cal_11 = alloc(mem, 2);
                link(mem, cal_11 + 0, ask_arg(mem, ask_arg(mem, term, 4), 0));
                link(mem, cal_11 + 1, Cal(5, 17, cal_10));
                u64 cal_12 = alloc(mem, 3);
                link(mem, cal_12 + 0, Ctr(0, 4, ctr_0));
                link(mem, cal_12 + 1, Cal(5, 17, cal_5));
                link(mem, cal_12 + 2, Cal(2, 28, cal_11));
                u64 done = Cal(3, 50, cal_12);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 5);
                clear(mem, get_loc(ask_arg(mem, term, 4), 0), 3);
                collect(mem, ask_arg(mem, term, 0));
...
int main(int argc, char* argv[]) {
  ...
  // Id-to-Name map
  const u64 id_to_name_size = 76;
  char* id_to_name_data[id_to_name_size];
  id_to_name_data[67] = "Insert_split_f_8";
  id_to_name_data[48] = "TriNat_c_2";
  id_to_name_data[32] = "X2264x2Ddec_split_a_3";
  id_to_name_data[44] = "X2264x2Drefl_1";
  id_to_name_data[47] = "TriNat_split_b_2";
  id_to_name_data[53] = "Leaf";
  id_to_name_data[46] = "TriNat_split_a_2";
  id_to_name_data[2] = "Leaf_1";
  id_to_name_data[33] = "X2264x2Ddec_d_3";
  id_to_name_data[22] = "Equal";
  id_to_name_data[29] = "X5Bx5D_0";
  id_to_name_data[40] = "TriNat_e_4";
  id_to_name_data[57] = "Ord.constructor";
  id_to_name_data[68] = "TDO.constructor_2";
  id_to_name_data[26] = "Test1_0";
  id_to_name_data[69] = "TDO.constructor";
  id_to_name_data[31] = "Node";
  id_to_name_data[25] = "Greater_3";
  id_to_name_data[51] = "Z_x2Bx2B__split_b_3";
  id_to_name_data[42] = "Ordx2DNat_0";
  id_to_name_data[0] = "FromList_split_c_3";
  id_to_name_data[65] = "Insert_m_11";
  id_to_name_data[9] = "X2264x2Dzero_1";
  id_to_name_data[17] = "Flatten_5";
  id_to_name_data[39] = "Main_0";
  id_to_name_data[30] = "Node_3";
  id_to_name_data[1] = "X5Bx5D";
  id_to_name_data[52] = "X2264x2Dtrans_5";
  id_to_name_data[55] = "X5Bx5Dx2Dx2264";
  id_to_name_data[64] = "If_3";
  id_to_name_data[34] = "X2264x2Ddec_3";
  id_to_name_data[19] = "Less";
  id_to_name_data[35] = "X2264x2Dtrans_split_d_5";
  id_to_name_data[16] = "Sort_3";
  id_to_name_data[70] = "Eq_2";
  id_to_name_data[4] = "Erased";
  id_to_name_data[27] = "TDOx2DNat_0";
  id_to_name_data[43] = "Ord.constructor_4";
  id_to_name_data[14] = "TriNat_0";
  id_to_name_data[73] = "X2Dx221Ex2Dx2264";
  id_to_name_data[5] = "Z_x2237_";
  id_to_name_data[62] = "Monus_split_3";
  id_to_name_data[72] = "Gt_split_1";
  id_to_name_data[18] = "TriNat_split_e_5";
  id_to_name_data[12] = "True";
  id_to_name_data[61] = "Monus_2";
  id_to_name_data[21] = "X2264x2Dsuc_3";
  id_to_name_data[15] = "TriNat_2";
  id_to_name_data[74] = "X2264x2Drefl_b_1";
  id_to_name_data[23] = "Equal_3";
  id_to_name_data[58] = "Lt_2";
  id_to_name_data[75] = "Gt_2";
  id_to_name_data[24] = "Greater";
  id_to_name_data[10] = "X2264x2Dzero";
  id_to_name_data[38] = "Main";
  id_to_name_data[28] = "Z_x2237__2";
  id_to_name_data[49] = "TriNat_split_b_3";
  id_to_name_data[11] = "Eq_split_1";
  id_to_name_data[54] = "X5Bx5Dx2Dx2264_3";
  id_to_name_data[71] = "X2264x2Drefl_split_a_1";
  id_to_name_data[3] = "X2Dx221Ex2Dx2264_1";
  id_to_name_data[6] = "Insert_8";
  id_to_name_data[36] = "X2264x2Dsuc";
  id_to_name_data[7] = "FromList_3";
  id_to_name_data[56] = "Insert_split_m_12";
  id_to_name_data[13] = "False";
  id_to_name_data[8] = "X2Bx221Ex2Dx2264_1";
  id_to_name_data[20] = "Less_3";
  id_to_name_data[50] = "Z_x2Bx2B__3";
  id_to_name_data[63] = "X2Bx221Ex2Dx2264";
  id_to_name_data[59] = "Lt_split_1";
  id_to_name_data[66] = "Tri_3";
  id_to_name_data[37] = "X2264x2Dtrans_split_e_8";
  id_to_name_data[45] = "X2264x2Dtrans_3";
  id_to_name_data[41] = "Flatten_split_e_5";
  id_to_name_data[60] = "TriNat_d_3";
;
