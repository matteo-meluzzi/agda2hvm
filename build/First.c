...
#define _BIND__SPLIT__C__4_ (2)
#define _TRIPLES__1_ (21)
#define _SUMALL__1_ (31)
#define _MAIN__0_ (9)
#define _BIND__4_ (7)
#define _MONUS__SPLIT__3_ (18)
#define _IF__THEN__ELSE____4_ (11)
#define _FILTER__3_ (0)
#define _SUMALL__SPLIT__A__1_ (19)
#define _EQ__SPLIT__1_ (13)
#define _PUTSTRLN__1_ (8)
#define _RANGE__2_ (33)
#define _ALLTRIPLES__1_ (22)
#define _TEST1__0_ (10)
#define _TRIPLE__3_ (35)
#define _MONUS__2_ (34)
#define _CONS__2_ (12)
#define _FILTER__SPLIT__C__3_ (1)
#define _GO__E__4_ (23)
#define _APPEND__3_ (5)
#define _NIL__0_ (32)
#define _APPEND__SPLIT__B__3_ (30)
#define _CARTESIAN__1_ (17)
#define _CARTESIAN__SPLIT__A__1_ (27)
#define _SUMALL__SPLIT__B__3_ (20)
#define _CARTESIAN__0_ (16)
#define _IF__THEN__ELSE____SPLIT__B__4_ (26)
#define _GO__SPLIT__C__4_ (25)
#define _MAIN_ (36)
#define _EQ__2_ (29)
#define _GO__4_ (24)
        ...
        case CAL: {
          ...
          //GENERATED_REWRITE_RULES_STEP_1_START//
          {
            case _BIND__SPLIT__C__4_: {
              ...
              if ((get_tag(ask_arg(mem, term, 2)) == CTR && get_ext(ask_arg(mem, term, 2)) == 3u)) {
                inc_cost(mem);
              ...
              if ((get_tag(ask_arg(mem, term, 2)) == CTR && get_ext(ask_arg(mem, term, 2)) == 4u)) {
                inc_cost(mem);
                ...
                link(mem, app_6 + 0, dp0_1);
                link(mem, app_6 + 1, ask_arg(mem, ask_arg(mem, term, 2), 0));
                u64 ctr_7 = alloc(mem, 0);
                u64 ctr_8 = alloc(mem, 0);
                u64 cal_9 = alloc(mem, 4);
                link(mem, cal_9 + 0, Ctr(0, 6, ctr_7));
                link(mem, cal_9 + 1, Ctr(0, 6, ctr_8));
                link(mem, cal_9 + 2, ask_arg(mem, ask_arg(mem, term, 2), 1));
                link(mem, cal_9 + 3, dp1_2);
                u64 cal_10 = alloc(mem, 3);
                link(mem, cal_10 + 0, Ctr(0, 6, ctr_5));
                link(mem, cal_10 + 1, App(app_6));
                link(mem, cal_10 + 2, Cal(4, 7, cal_9));
                u64 done = Cal(3, 5, cal_10);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 4);
            ...
            case _TRIPLES__1_: {
              if (1) {
                ...
                link(mem, cal_3 + 0, Ctr(0, 6, ctr_0));
                link(mem, cal_3 + 1, Cal(0, 16, cal_1));
                link(mem, cal_3 + 2, Cal(1, 22, cal_2));
                u64 done = Cal(3, 0, cal_3);
                link(mem, host, done);
            ...
            case _SUMALL__SPLIT__A__1_: {
              ...
              if ((get_tag(ask_arg(mem, term, 0)) == CTR && get_ext(ask_arg(mem, term, 0)) == 4u)) {
                ...
                link(mem, cal_11 + 0, Ctr(2, 4, ctr_10));
                link(mem, cal_11 + 1, dp1_7);
                link(mem, cal_11 + 2, dp1_2);
                u64 done = Cal(3, 20, cal_11);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
            ...
            case _RANGE__2_: {
              if (1) {
                ...
                link(mem, cal_10 + 0, Ctr(0, 6, ctr_5));
                link(mem, cal_10 + 1, Ctr(0, 6, ctr_6));
                link(mem, cal_10 + 2, Cal(2, 34, cal_9));
                link(mem, cal_10 + 3, dp1_2);
                u64 done = Cal(4, 24, cal_10);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 2);
                init = 1;
                continue;
            ...
            case _ALLTRIPLES__1_: {
              if (1) {
                ...
                link(mem, cal_24 + 0, Cal(3, 35, cal_22));
                link(mem, cal_24 + 1, Cal(0, 32, cal_23));
                link(mem, lam_21 + 1, Cal(2, 12, cal_24));
                u64 cal_25 = alloc(mem, 4);
                link(mem, cal_25 + 0, Ctr(0, 6, ctr_18));
                link(mem, cal_25 + 1, Ctr(0, 6, ctr_19));
                link(mem, cal_25 + 2, Cal(2, 33, cal_20));
                link(mem, cal_25 + 3, Lam(lam_21));
                link(mem, lam_12 + 1, Cal(4, 7, cal_25));
                u64 cal_26 = alloc(mem, 4);
                link(mem, cal_26 + 0, Ctr(0, 6, ctr_9));
                link(mem, cal_26 + 1, Ctr(0, 6, ctr_10));
                link(mem, cal_26 + 2, Cal(2, 33, cal_11));
                link(mem, cal_26 + 3, Lam(lam_12));
                link(mem, lam_3 + 1, Cal(4, 7, cal_26));
                u64 cal_27 = alloc(mem, 4);
                link(mem, cal_27 + 0, Ctr(0, 6, ctr_0));
                link(mem, cal_27 + 1, Ctr(0, 6, ctr_1));
                link(mem, cal_27 + 2, Cal(2, 33, cal_2));
                link(mem, cal_27 + 3, Lam(lam_3));
                u64 done = Cal(4, 7, cal_27);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
                init = 1;
                continue;
            ...
            case _TEST1__0_: {
              if (1) {
                inc_cost(mem);
                u64 cal_0 = alloc(mem, 1);
                link(mem, cal_0 + 0, U_32(20));
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Cal(1, 21, cal_0));
                u64 done = Cal(1, 31, cal_1);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
                continue;
            ...
            case _FILTER__SPLIT__C__3_: {
              ...
              if ((get_tag(ask_arg(mem, term, 2)) == CTR && get_ext(ask_arg(mem, term, 2)) == 4u)) {
                ...
                link(mem, app_21 + 0, dp1_12);
                link(mem, app_21 + 1, dp0_6);
                u64 ctr_22 = alloc(mem, 0);
                u64 cal_23 = alloc(mem, 3);
                link(mem, cal_23 + 0, Ctr(0, 6, ctr_22));
                link(mem, cal_23 + 1, dp0_16);
                link(mem, cal_23 + 2, dp0_1);
                u64 cal_24 = alloc(mem, 2);
                link(mem, cal_24 + 0, dp1_7);
                link(mem, cal_24 + 1, Cal(3, 0, cal_23));
                u64 ctr_25 = alloc(mem, 0);
                u64 cal_26 = alloc(mem, 3);
                link(mem, cal_26 + 0, Ctr(0, 6, ctr_25));
                link(mem, cal_26 + 1, dp1_17);
                link(mem, cal_26 + 2, dp1_2);
                u64 cal_27 = alloc(mem, 4);
                link(mem, cal_27 + 0, Ctr(0, 6, ctr_20));
                link(mem, cal_27 + 1, App(app_21));
                link(mem, cal_27 + 2, Cal(2, 12, cal_24));
                link(mem, cal_27 + 3, Cal(3, 0, cal_26));
                u64 done = Cal(4, 11, cal_27);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 3);
                clear(mem, get_loc(ask_arg(mem, term, 2), 0), 2);
                collect(mem, ask_arg(mem, term, 0));
            ...
            case _APPEND__SPLIT__B__3_: {
              ...
              if ((get_tag(ask_arg(mem, term, 1)) == CTR && get_ext(ask_arg(mem, term, 1)) == 4u)) {
                inc_cost(mem);
                u64 ctr_0 = alloc(mem, 0);
                u64 cal_1 = alloc(mem, 3);
                link(mem, cal_1 + 0, Ctr(0, 6, ctr_0));
                ...
                link(mem, cal_2 + 1, Cal(3, 5, cal_1));
                u64 done = Cal(2, 12, cal_2);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 3);
            ...
            case _CARTESIAN__SPLIT__A__1_: {
              ...
              if ((get_tag(ask_arg(mem, term, 0)) == CTR && get_ext(ask_arg(mem, term, 0)) == 28u)) {
                ...
                u64 cpy_5 = ask_arg(mem, ask_arg(mem, term, 0), 1);
                u64 dp0_6;
                u64 dp1_7;
                if (get_tag(cpy_5) == U32) {
                  inc_cost(mem);
                ...
                u64 cpy_10 = ask_arg(mem, ask_arg(mem, term, 0), 0);
                u64 dp0_11;
                u64 dp1_12;
                if (get_tag(cpy_10) == U32) {
                  inc_cost(mem);
                ...
                u64 ret_17;
                if (get_tag(dp0_11) == U32 && get_tag(dp1_12) == U32) {
                  ret_17 = U_32(get_val(dp0_11) * get_val(dp1_12));
                  inc_cost(mem);
                } else {
                  u64 op2_18 = alloc(mem, 2);
                  link(mem, op2_18 + 0, dp0_11);
                  link(mem, op2_18 + 1, dp1_12);
                  ret_17 = Op2(MUL, op2_18);
                }
                u64 ret_19;
                if (get_tag(dp0_6) == U32 && get_tag(dp1_7) == U32) {
                  ret_19 = U_32(get_val(dp0_6) * get_val(dp1_7));
                  inc_cost(mem);
                } else {
                  u64 op2_20 = alloc(mem, 2);
                  link(mem, op2_20 + 0, dp0_6);
                  link(mem, op2_20 + 1, dp1_7);
                  ret_19 = Op2(MUL, op2_20);
                }
                u64 ret_15;
                if (get_tag(ret_17) == U32 && get_tag(ret_19) == U32) {
                  ret_15 = U_32(get_val(ret_17) + get_val(ret_19));
                  inc_cost(mem);
                } else {
                  u64 op2_16 = alloc(mem, 2);
                  link(mem, op2_16 + 0, ret_17);
                  link(mem, op2_16 + 1, ret_19);
                  ret_15 = Op2(ADD, op2_16);
                }
                u64 ret_21;
                if (get_tag(dp0_1) == U32 && get_tag(dp1_2) == U32) {
                  ret_21 = U_32(get_val(dp0_1) * get_val(dp1_2));
                  inc_cost(mem);
                } else {
                  u64 op2_22 = alloc(mem, 2);
                  link(mem, op2_22 + 0, dp0_1);
                  link(mem, op2_22 + 1, dp1_2);
                  ret_21 = Op2(MUL, op2_22);
                }
                u64 cal_23 = alloc(mem, 2);
                link(mem, cal_23 + 0, ret_15);
                link(mem, cal_23 + 1, ret_21);
                u64 done = Cal(2, 29, cal_23);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
            ...
            case _SUMALL__SPLIT__B__3_: {
              ...
              if ((get_tag(ask_arg(mem, term, 1)) == CTR && get_ext(ask_arg(mem, term, 1)) == 28u)) {
                inc_cost(mem);
                u64 cal_6 = alloc(mem, 1);
                link(mem, cal_6 + 0, ask_arg(mem, term, 2));
                u64 ret_4;
                if (get_tag(Cal(1, 31, cal_6)) == U32 && get_tag(ask_arg(mem, ask_arg(mem, term, 1), 0)) == U32) {
                  ret_4 = U_32(get_val(Cal(1, 31, cal_6)) + get_val(ask_arg(mem, ask_arg(mem, term, 1), 0)));
                  inc_cost(mem);
                } else {
                  u64 op2_5 = alloc(mem, 2);
                  link(mem, op2_5 + 0, Cal(1, 31, cal_6));
                  link(mem, op2_5 + 1, ask_arg(mem, ask_arg(mem, term, 1), 0));
                  ret_4 = Op2(ADD, op2_5);
                }
                u64 ret_2;
                if (get_tag(ret_4) == U32 && get_tag(ask_arg(mem, ask_arg(mem, term, 1), 1)) == U32) {
                  ret_2 = U_32(get_val(ret_4) + get_val(ask_arg(mem, ask_arg(mem, term, 1), 1)));
                  inc_cost(mem);
                } else {
                  u64 op2_3 = alloc(mem, 2);
                  link(mem, op2_3 + 0, ret_4);
                  link(mem, op2_3 + 1, ask_arg(mem, ask_arg(mem, term, 1), 1));
                  ret_2 = Op2(ADD, op2_3);
                }
                u64 ret_0;
                if (get_tag(ret_2) == U32 && get_tag(ask_arg(mem, ask_arg(mem, term, 1), 2)) == U32) {
                  ret_0 = U_32(get_val(ret_2) + get_val(ask_arg(mem, ask_arg(mem, term, 1), 2)));
                  inc_cost(mem);
                } else {
                  u64 op2_1 = alloc(mem, 2);
                  link(mem, op2_1 + 0, ret_2);
                  link(mem, op2_1 + 1, ask_arg(mem, ask_arg(mem, term, 1), 2));
                  ret_0 = Op2(ADD, op2_1);
                }
                u64 done = ret_0;
                link(mem, host, done);
            ...
            case _CARTESIAN__0_: {
              if (1) {
                ...
                link(mem, lam_0 + 1, Cal(1, 17, cal_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
            ...
            case _IF__THEN__ELSE____SPLIT__B__4_: {
              ...
              if ((get_tag(ask_arg(mem, term, 1)) == CTR && get_ext(ask_arg(mem, term, 1)) == 15u)) {
                inc_cost(mem);
            ...
            case _GO__SPLIT__C__4_: {
              ...
              if (1) {
                ...
                link(mem, cal_15 + 0, Ctr(0, 6, ctr_11));
                link(mem, cal_15 + 1, Ctr(0, 6, ctr_12));
                link(mem, cal_15 + 2, Cal(4, 23, cal_10));
                link(mem, cal_15 + 3, ret_13);
                u64 cal_16 = alloc(mem, 2);
                link(mem, cal_16 + 0, dp0_6);
                link(mem, cal_16 + 1, Cal(4, 24, cal_15));
                u64 done = Cal(2, 12, cal_16);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 4);
                init = 1;
                continue;
...
int main(int argc, char* argv[]) {
  ...
  // Id-to-Name map
  const u64 id_to_name_size = 38;
  char* id_to_name_data[id_to_name_size];
  id_to_name_data[10] = "Test1_0";
  id_to_name_data[8] = "PutStrLn_1";
  id_to_name_data[9] = "Main_0";
  id_to_name_data[15] = "False";
  id_to_name_data[23] = "Go_e_4";
  id_to_name_data[2] = "Bind_split_c_4";
  id_to_name_data[20] = "Sumall_split_b_3";
  id_to_name_data[30] = "Append_split_b_3";
  id_to_name_data[13] = "Eq_split_1";
  id_to_name_data[22] = "Alltriples_1";
  id_to_name_data[27] = "Cartesian_split_a_1";
  id_to_name_data[11] = "If_then_else__4";
  id_to_name_data[3] = "Nil";
  id_to_name_data[28] = "Triple";
  id_to_name_data[19] = "Sumall_split_a_1";
  id_to_name_data[37] = "Main_1";
  id_to_name_data[18] = "Monus_split_3";
  id_to_name_data[31] = "Sumall_1";
  id_to_name_data[32] = "Nil_0";
  id_to_name_data[35] = "Triple_3";
  id_to_name_data[33] = "Range_2";
  id_to_name_data[34] = "Monus_2";
  id_to_name_data[14] = "True";
  id_to_name_data[24] = "Go_4";
  id_to_name_data[25] = "Go_split_c_4";
  id_to_name_data[0] = "Filter_3";
  id_to_name_data[26] = "If_then_else__split_b_4";
  id_to_name_data[6] = "Matteo";
  id_to_name_data[21] = "Triples_1";
  id_to_name_data[4] = "Cons";
  id_to_name_data[7] = "Bind_4";
  id_to_name_data[36] = "Main";
  id_to_name_data[5] = "Append_3";
  id_to_name_data[16] = "Cartesian_0";
  id_to_name_data[29] = "Eq_2";
  id_to_name_data[1] = "Filter_split_c_3";
  id_to_name_data[12] = "Cons_2";
  id_to_name_data[17] = "Cartesian_1";
;
