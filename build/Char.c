...
#define _MONUS__2_ (2)
#define _MONUS__SPLIT__3_ (3)
#define _LT__2_ (0)
#define _GT__2_ (10)
#define _PUTSTRLN__1_ (9)
...
int main(int argc, char* argv[]) {
  ...
  id_to_name_data[9] = "PutStrLn_1";
  id_to_name_data[3] = "Monus_split_3";
  id_to_name_data[6] = "False";
  id_to_name_data[5] = "True";
  id_to_name_data[1] = "Lt_split_1";
  id_to_name_data[7] = "Main";
  id_to_name_data[10] = "Gt_2";
  id_to_name_data[2] = "Monus_2";
  id_to_name_data[0] = "Lt_2";
  id_to_name_data[8] = "Main_1";
