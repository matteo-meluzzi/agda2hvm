...
#define _MAIN_ (6)
#define _GT__SPLIT__1_ (4)
#define _LT__SPLIT__1_ (0)
#define _GT__2_ (5)
#define _LT__2_ (10)
#define _MONUS__SPLIT__3_ (8)
#define _PUTSTRLN__1_ (3)
#define _MONUS__2_ (9)
...
int main(int argc, char* argv[]) {
  ...
  id_to_name_data[8] = "Monus_split_3";
  id_to_name_data[6] = "Main";
  id_to_name_data[5] = "Gt_2";
  id_to_name_data[10] = "Lt_2";
  id_to_name_data[7] = "Main_1";
  id_to_name_data[4] = "Gt_split_1";
  id_to_name_data[2] = "False";
  id_to_name_data[9] = "Monus_2";
  id_to_name_data[3] = "PutStrLn_1";
  id_to_name_data[1] = "True";
  id_to_name_data[0] = "Lt_split_1";
;
